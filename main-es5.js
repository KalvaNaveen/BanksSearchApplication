...
var CACHE_BANK_KEY = 'bankDada';
var ApiService = /** @class */ (function () {
    function ApiService(http) {
        this.http = http;
    }
    ApiService.prototype.fetchBanksData = function (city) {
        var apiURLPath = "https://vast-shore-74260.herokuapp.com/banks?city=" + city;
        return this.http.get(apiURLPath).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (responseData) { return responseData; }));
    };
...
var BankDetailsComponent = /** @class */ (function () {
    function BankDetailsComponent(route) {
        this.route = route;
    }
    BankDetailsComponent.prototype.ngOnInit = function () {
        ...
        this.route.paramMap.subscribe(function (params) {
            _this.banks = JSON.parse(localStorage['bankDada']).filter(function (a) { return a.bank_id === +params.get('bank_id'); }).map(function (newData) { return newData; });
        });
    };
    BankDetailsComponent.ctorParameters = function () { return [
...
var CACHE_BANK_KEY = 'bankDada', CACHE_CITY_KEY = 'City';
var BanksComponent = /** @class */ (function () {
    function BanksComponent(api) {
        this.api = api;
    ...
    BanksComponent.prototype.ngOnInit = function () {
        var city = localStorage[CACHE_CITY_KEY];
        var banks = JSON.parse(localStorage[CACHE_BANK_KEY] || '[]');
    ...
    BanksComponent.prototype.getBanks = function () {
        var _this = this;
        this.isLoading = true;
        this.api.fetchBanksData(this.selectedCity).subscribe(function (fetchedData) { return _this.LoadBankDetails(fetchedData); });
    };
    // To Load table after fetching data using API or Local Storage & its a Generic Function...................................
    BanksComponent.prototype.LoadBankDetails = function (banks) {
    ...
    BanksComponent.prototype.applyFilter = function (filterValue) {
    ...
    BanksComponent.prototype.selectRow = function ($event, row) {
        var e_1, _a, e_2, _b;
        var localCachedData = JSON.parse(localStorage[CACHE_BANK_KEY] || '[]');
        if ($event.checked) {
            try {
                for (var _c = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](localCachedData.entries()), _d = _c.next(); !_d.done; _d = _c.next()) {
                    var _e = tslib__WEBPACK_IMPORTED_MODULE_0__["__read"](_d.value, 2), i = _e[0], element = _e[1];
            ...
            try {
                for (var _f = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](localCachedData.entries()), _g = _f.next(); !_g.done; _g = _f.next()) {
                    var _h = tslib__WEBPACK_IMPORTED_MODULE_0__["__read"](_g.value, 2), i = _h[0], element = _h[1];
                    if (element.ifsc === row.ifsc) {
                        localCachedData[i].favourite = $event.checked;
                        localStorage[CACHE_BANK_KEY] = JSON.stringify(localCachedData);
                    }
...
var cities = ['BANGALORE', 'CHENNAI', 'HYDERABAD', 'MUMBAI', 'NEW DELHI'
];
